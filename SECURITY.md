...
MiniCart Admin exists for DevSecOps workshop and local security training. Current branch is `lesson/04-dast-fixes`, final remediation lesson branch. Use only for teaching.
...
Current branch is partially fixed branch. It is suitable for:

- compare against `lesson/01-vulnerable`
- show SAST/auth fixes
- rescan before SCA and DAST lessons
